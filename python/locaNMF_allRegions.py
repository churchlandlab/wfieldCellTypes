# -*- coding: utf-8 -*-
"""
Created on Sun Feb 21 18:40:51 2021
...
def locaNMF_runWithLocalV(animal):
    ...
    minrank = 1; maxrank = 200; # rank = how many components per brain region. Set maxrank to around 10 for regular dataset.
    rank_range = (minrank, maxrank, 1)
    min_pixels = 100 # minimum number of pixels in Allen map for it to be considered a brain region
    loc_thresh = 1 # Localization threshold, i.e. percentage of area restricted to be inside the 'Allen boundary'
    ...
    regionMap = sio.loadmat(basefolder+'wholeFrameMap.mat')['wholeFrameMap']
    a = regionMap.shape
